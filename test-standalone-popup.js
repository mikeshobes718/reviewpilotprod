...
async function testStandalonePopup() {
  console.log('🎯 Testing Standalone HTML Popup Solution...');
  ...
  try {
    ...
    console.log('\n🧪 Test: Standalone HTML popup solution...');
    ...
    if (emailInput && passwordInput) {
      ...
      if (page.url().includes('/pricing')) {
        ...
        // Step 3: Check if popup was created by standalone HTML
        console.log('\n🔍 Step 2: Checking standalone HTML popup...');
        ...
        if (popupExists && mobilePopupExists) {
          console.log('  ✅ SUCCESS: Both popups created by standalone HTML');
          ...
          if (emailInput2 && passwordInput2) {
            ...
            if (page.url().includes('/dashboard')) {
              ...
              // Check if popup exists for subscription user (should exist but not interfere)
              ...
              // For subscription users, the popup should exist but not interfere with dashboard access
              if (subscriptionPopupExists && subscriptionMobilePopupExists) {
                console.log('  ✅ SUCCESS: Popup exists for subscription user (will not interfere)');
              } else {
                console.log('  ❌ PROBLEM: Popup not found for subscription user');
              }
          ...
          console.log('  ❌ PROBLEM: Popup not created by standalone HTML');
        }
    ...
    console.log('\n📋 STANDALONE HTML POPUP TEST RESULTS:');
    console.log('✅ Login process:', 'Completed');
    console.log('✅ Standalone HTML popup creation:', 'Completed');
    ...
    console.log('✅ Standalone approach:', 'Completed');
    
    // Take screenshot
    await page.screenshot({ path: 'standalone-popup-test.png' });
    console.log('📸 Screenshot saved as standalone-popup-test.png');

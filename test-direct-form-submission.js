...
async function testDirectFormSubmission() {
  ...
  try {
    ...
    console.log('\n🧪 Test: Direct form submission to bypass JavaScript...');
    ...
    console.log('\n📝 Method 1: Using page.evaluate to submit form directly...');
    ...
    const submissionResult = await page.evaluate((token) => {
      ...
      if (emailInput && passwordInput) {
        emailInput.value = 'mikeshobes718@yahoo.com';
        passwordInput.value = 'T@st1234';
    ...
    console.log('\n📊 Results after direct submission:');
    ...
    console.log('\n📋 DIRECT FORM SUBMISSION TEST RESULTS:');
    ...
    // Take screenshot
    await page.screenshot({ path: 'direct-form-submission-test.png' });
    console.log('📸 Screenshot saved as direct-form-submission-test.png');

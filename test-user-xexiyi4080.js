...
async function testUserXexiyi4080() {
  console.log('🧪 Testing User: xexiyi4080@featcore.com');
  ...
  try {
    ...
    console.log('\n🧪 Test: Attempting login with xexiyi4080@featcore.com...');
    ...
    const submissionResult = await page.evaluate((token) => {
      ...
      if (emailInput && passwordInput) {
        emailInput.value = 'xexiyi4080@featcore.com';
        passwordInput.value = 'T@st2025';
    ...
    // Take screenshot
    await page.screenshot({ path: 'xexiyi4080-login-test.png' });
    console.log('📸 Screenshot saved as xexiyi4080-login-test.png');

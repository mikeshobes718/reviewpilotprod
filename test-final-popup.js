...
async function testFinalPopup() {
  console.log('🎯 Testing Final Simplified Popup Solution...');
  ...
  try {
    ...
    console.log('\n🧪 Test: Final simplified popup solution...');
    ...
    if (emailInput && passwordInput) {
      ...
      if (page.url().includes('/pricing')) {
        ...
        // Step 3: Check if popup was created by template
        console.log('\n🔍 Step 2: Checking template-created popup...');
        ...
        if (popupExists && mobilePopupExists) {
          console.log('  ✅ SUCCESS: Both popups created by template');
          ...
          console.log('  ❌ PROBLEM: Popup not created by template');
        }
    ...
    console.log('\n📋 FINAL POPUP SOLUTION TEST RESULTS:');
    console.log('✅ Login process:', 'Completed');
    console.log('✅ Template popup creation:', 'Completed');
    ...
    console.log('✅ Simplified solution:', 'Completed');
    
    // Take screenshot
    await page.screenshot({ path: 'final-popup-test.png' });
    console.log('📸 Screenshot saved as final-popup-test.png');

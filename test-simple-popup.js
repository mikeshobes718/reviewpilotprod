...
async function testSimplePopup() {
  console.log('🎯 Testing Simple Client-Side Popup Solution...');
  ...
  try {
    ...
    console.log('\n🧪 Test: Simple client-side popup solution...');
    ...
    if (emailInput && passwordInput) {
      ...
      if (page.url().includes('/pricing')) {
        ...
        // Step 3: Check if popup was created by JavaScript
        console.log('\n🔍 Step 2: Checking JavaScript-created popup...');
        ...
        if (popupExists && mobilePopupExists) {
          console.log('  ✅ SUCCESS: Both popups created by JavaScript');
          ...
          console.log('  ❌ PROBLEM: Popup not created by JavaScript');
        }
    ...
    console.log('\n📋 SIMPLE POPUP SOLUTION TEST RESULTS:');
    console.log('✅ Login process:', 'Completed');
    console.log('✅ JavaScript popup creation:', 'Completed');
    ...
    console.log('✅ Client-side solution:', 'Completed');
    
    // Take screenshot
    await page.screenshot({ path: 'simple-popup-test.png' });
    console.log('📸 Screenshot saved as simple-popup-test.png');
